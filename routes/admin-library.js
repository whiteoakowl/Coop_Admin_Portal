...
router.post('/library/types', (req, res) => {
...
router.post('/library/scan-member', (req, res) => {
...
router.post('/library/scan-item', (req, res) => {
  const barcode = (req.body.barcode || '').trim();
...
router.post('/library/scan-checkin', (req, res) => {
  const barcode = (req.body.barcode || '').trim();
  const item = barcode ? findItemByBarcode(barcode) : null;
  if (!item) return res.json({ ok: false, message: 'No library item matches that barcode.' });
...
router.post('/library/checkouts/:id/return', (req, res) => {
...
// Titles catalog CRUD
router.post('/library/items/new', (req, res) => {
...
router.post('/library/items/:id/edit', (req, res) => {
...
router.post('/library/items/:id/delete', (req, res) => {
